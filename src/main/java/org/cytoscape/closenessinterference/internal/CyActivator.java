...
public class CyActivator extends AbstractCyActivator {
    ...
    public ClosenessMenuAction menuaction;
    ...
    public void start(BundleContext context) throws Exception {
        ...
        System.out.println("Closeness Interference is loaded");
        ...
        menuaction = new ClosenessMenuAction(cyApplicationManager, "Closeness Interference" + version, this);
