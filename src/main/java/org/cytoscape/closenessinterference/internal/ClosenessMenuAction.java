 ...
 */
package org.cytoscape.closenessinterference.internal;
 ...
 * @author faizi
 */
public class ClosenessMenuAction extends AbstractCyAction {

    public CyApplicationManager cyApplicationManager;
    public CySwingApplication cyDesktopService;
    public CyActivator cyactivator;

    public ClosenessMenuAction(CyApplicationManager cyApplicationManager, final String menuTitle, CyActivator cyactivator) {
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        Thread timer = new Thread() {
            ...
            public void run() {
                ...
                int n = nodeList.size();
                double[][] adjM = createAdjMatrix(network, nodeList, n);
                double[][] D = adjM.clone();
                runFloydAlgo(D);
                ...
                buffer.append("Closeness centralities of whole network (with all nodes): ");
                buffer.append("\n");
                int k = 0;
                for (CyNode root : nodeList) {
                    if (k < n) {
                ...
                buffer.append("Closeness centralities of network without the selected nodes: ");
                buffer.append("\n");
                k = 0;
                for (CyNode root : nodeList) {
                    if (k < n2) {
                ...
                buffer.append("\n");
                buffer.append("Closeness interference in % : ");
                buffer.append("\n");
    ...
    public static double[][] createAdjMatrix(CyNetwork currentnetwork, List<CyNode> nodeList, int totalnodecount) {
